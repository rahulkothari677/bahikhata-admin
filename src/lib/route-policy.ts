...
export const ROUTE_POLICY: Record<string, RoutePolicy> = {
  ...
  'admin/database/grants': { GET: [], purpose: 'Check the live role can DELETE from the tables the panel deletes from', pii: 'none', lawfulBasis: LEGIT_OPS, verdict: 'keep', note: 'Reads has_table_privilege only. Exists because a missing DELETE grant made 13 admin routes fail with an unclassifiable 500.' },
